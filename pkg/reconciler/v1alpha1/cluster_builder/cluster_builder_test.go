...
import (
	...
	"github.com/pivotal/kpack/pkg/reconciler/v1alpha1/cluster_builder/cluster_builderfakes"
)
...
func testBuilderReconciler(t *testing.T, when spec.G, it spec.S) {
	fakeMetadataRetriever := &cluster_builderfakes.FakeMetadataRetriever{}

	fakeEnqueuer := &cluster_builderfakes.FakeEnqueuer{}
